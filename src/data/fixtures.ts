export default {
  author: "sridip dutta.",
  hero: {
    subtitle: "software engineer at economize.cloud.",
    description: "building saas platform for cloud cost observability/monitoring, optimization & recommendation.",
    cta: "Resume",
  },
  products: {
    featured: [
  ...
  footer: {
    tagline: "Sridip Dutta — Kolkata, India",
    links: [
      {
        name: "Twitter",
        url: "https://twitter.com/SridipDutta",
        fa: "fab fa-twitter" // Code from: https://fontawesome.com/v5/icons/twitter?s=brands
      },
      {
        name: "Github",
        url: "https://github.com/sensrdt",
        fa: "fab fa-github"
      },
      {
        name: "Linkedin",
        url: "https://www.linkedin.com/in/sensrdt/",
        fa: "fab fa-linkedin"
      },
      {
        name: "Email",
        url: "mailto:stsdutta2@gmail.com",
        fa: "fa fa-envelope"
      },
    ]
  }
